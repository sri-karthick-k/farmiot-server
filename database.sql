...
CREATE TABLE DEVICE_MANAGEMENT(UID INT, DEVICE_ID SERIAL, ACCESS BOOLEAN, PRIMARY KEY(UID, DEVICE_ID), FOREIGN KEY (UID) REFERENCES user_details (uid), FOREIGN KEY (device_id) REFERENCES device (device_id));
